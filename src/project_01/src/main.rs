fn main() {
    ...
    println!("My favorite seasons is {season}. The team scored {1} points, with each touchdown worth {0} points. The event starts at {event_time} o'clock.", TOUCHDOWN_POINTS, points_scored ); 
