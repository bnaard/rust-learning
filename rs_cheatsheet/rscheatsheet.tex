...
{\begin{mdframed}[linecolor=black,
                  ...
                  frametitle={\footnotesize \bfseries \hspace*{0mm} #1},
                  % frametitlerule=true,
...
% global
\setminted{breaklines=true, fontsize=\scriptsize, autogobble=true}
...
\section*{\LARGE \rmfamily
  RUST \textcolor{orange}{\mdseries for beginners}}
...
\begin{multicols*}{4}
  ...
  \begin{myboxed}{Quick start \hfill
    ...
    {
      % Adjust code/notes column split by changing the fraction below
      % Example: \setcodeleftfraction{0.7} sets 70% of the width for the code
      \setcodeleftfraction{0.5}%
      % compute widths relative to current \columnwidth
      \setlength{\leftcolwidth}{\codeleftfraction\columnwidth}%
      \setlength{\rightcolwidth}{\dimexpr\columnwidth-\leftcolwidth\relax}%

      % Left: code (minted). Right: notes (itemize). Use minipages so
      % minted (verbatim) works correctly.
      \noindent
...
fn main() {
  println!("Hello, World!");
      ...
      \end{minipage}\hfill
        ...
        \begin{itemize}[nosep]
          \item Example bullet 1
          \item Example bullet 2
