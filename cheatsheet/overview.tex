...
\begin{tcbposter}[
    ...
    \begin{posterboxenv}[skin=cheatboxorangeskin, adjusted title=Flow Control]
        ...
        \begin{tcblisting}{skin=mintedrust}
            ...
            x = 42;                // error: cannot assign twice to immutable variable
            y = 2.71;              // ok: y is mutable
            _unused_variable = 5;  // start with underscore to suppress warnings
        \end{tcblisting}
   ...
   \end{posterboxenv}
    ...
    % === Constants ================================================================
    \begin{posterboxenv}[skin=cheatboxorangeskin, adjusted title=Constants]
        {name=constants,column=10,below=functions, span=3}
        Immutable by default, declared in any scope, must be type-annotated and must be computable at compile time.
        \begin{tcblisting}{skin=mintedrust}
            const THREE_HOURS_IN_SECONDS: u32 = 60 * 60 * 3;
            let n = THREE_HOURS_IN_SECONDS;
        \end{tcblisting}
