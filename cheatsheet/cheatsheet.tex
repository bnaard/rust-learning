...
% Posterbox environment for cheatsheet sections
\NewDocumentEnvironment{cheatposterbox}{}
    {
        \begin{posterboxenv}[title=My title]{name=A,column=5,row=2, span=2, rowspan=3}
    }
    {
        \end{posterboxenv}
    }

\NewDocumentEnvironment{mycustomenv}{ O{} m }% #1 optional, #2 mandatory
{%
  % Begin code: open posterboxenv with passed arguments
  \begin{posterboxenv}[#1]{#2}%
}%
{%
  % End code: close posterboxenv
  \end{posterboxenv}%
}
...
\begin{tcbposter}[
        poster = {showframe,spacing=1em, columns=12},
        boxes = {beamer,colframe=blue!50!black,colback=blue!50,colupper=yellow!50},
    ]

    \begin{posterboxenv}{name=B,column=1,row=1, span=2, rowspan=2}
        My first box.
    \end{posterboxenv}

    % \begin{mycustomenv}[title=My title]{name=A,column=5,row=2, span=2, rowspan=3}
    %     Content here.
    % \end{mycustomenv}
...
\begin{tcbraster}[raster columns=12]
    ...
    % --- Overview -------------------------------------------------------------
    \begin{tcolorbox}[skin=cheatboxorangeskin, title=Overview, raster multicolumn=3]
    ...
    % --- Tools ----------------------------------------------------------------
    \begin{tcolorbox}[skin=cheatboxorangeskin, title=Tools, raster multicolumn=3]
